...
def get_available_games(game_folder):
    """
    Loads and returns sample_games in the sample_games folder.
    """
    games = []
...
def get_game_from_game_id(game_folder, game_id):
    """
    ...
    """
    games = get_available_games(game_folder)
    for game in games:
